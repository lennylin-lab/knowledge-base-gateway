...
|-------|-------------|--------|
| [Directory Structure](./directory-structure.md) | Module organization and file layout | Complete (planned Go layout) |
| [Database Guidelines](./database-guidelines.md) | PostgreSQL/Redis boundaries, queries, migrations | Complete (planned persistence) |
